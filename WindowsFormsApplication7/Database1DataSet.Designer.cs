...
namespace WindowsFormsApplication7 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class DataDataTable : global::System.Data.TypedTableBase<DataRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataRow AddDataRow(string user_name, System.DateTime date) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataRow FindByuser_name(string user_name) {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(System.DateTime First_Date) {
        ...
        public partial class DataRow : global::System.Data.DataRow {
            ...
            public string user_name {
                get {
                    return ((string)(this[this.tableData.user_nameColumn]));
                }
                set {
                    this[this.tableData.user_nameColumn] = value;
                }
            }
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public System.DateTime First_Date {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableTable.First_DateColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'First_Date\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.First_DateColumn] = value;
                }
            }
            ...
            public bool IsFirst_DateNull() {
                return this.IsNull(this.tableTable.First_DateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetFirst_DateNull() {
                this[this.tableTable.First_DateColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WindowsFormsApplication7.Database1DataSetTableAdapters {
    ...
    public partial class DataTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Data] WHERE (([user_name] = @Original_user_name) AND ([date] =" +
                " @Original_date))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Data] ([user_name], [date]) VALUES (@user_name, @date);\r\nSELEC" +
                "T user_name, date FROM Data WHERE (user_name = @user_name)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Data] SET [user_name] = @user_name, [date] = @date WHERE (([user_na" +
                "me] = @Original_user_name) AND ([date] = @Original_date));\r\nSELECT user_name, da" +
                "te FROM Data WHERE (user_name = @user_name)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication7.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT user_name, date FROM dbo.Data";
        ...
        public virtual int Delete(string Original_user_name, System.DateTime Original_date) {
        ...
        public virtual int Insert(string user_name, System.DateTime date) {
            if ((user_name == null)) {
        ...
        public virtual int Update(string user_name, System.DateTime date, string Original_user_name, System.DateTime Original_date) {
            if ((user_name == null)) {
                throw new global::System.ArgumentNullException("user_name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime date, string Original_user_name, System.DateTime Original_date) {
            return this.Update(Original_user_name, date, Original_user_name, Original_date);
        }
    }
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("First_Date", "First_Date");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([First_Date]) VALUES (@First_Date)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@First_Date", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "First_Date", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT First_Date FROM dbo.[Table]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(global::System.Nullable<global::System.DateTime> First_Date) {
            if ((First_Date.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[0].Value = ((System.DateTime)(First_Date.Value));
            }
            else {
